...
Root `AGENTS.md` is the short project contract. This directory holds detailed
rules that agents should read only when relevant.
...
put it in `loop-develop/current-todo/`.

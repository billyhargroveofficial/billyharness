...
- [ADR 0009](0009-manage-loopback-gateway-token-in-dedicated-home-file.md):
  accepted; normal loopback startup and local clients share a private managed
  gateway token without exposing it to remote URLs.

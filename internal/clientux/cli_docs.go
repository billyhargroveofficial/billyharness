...
var cliCommandDocs = []CLICommandDoc{
	...
	{Name: "agentclub", Aliases: []string{"agent-club"}, Summary: "inspect agent-club capabilities, proposals, and local config"},
...
var baseDoctorCheckDocs = []doctorCheckDoc{
	...
	{Name: "agentclub config", Description: "Validate configured agent-club registry JSON files and secret env references without executing capabilities.", Modes: []string{"local", "production"}},

...
func (s *Server) routeSpecs() []routeSpec {
	return []routeSpec{
		...
		{Method: "POST", Pattern: "/v1/agentclub/triggers/{binding_id}/deliveries", Handler: s.handleAgentClubTriggerDelivery, Summary: "Verify and admit an agent-club trigger delivery", Request: "agentclub.TriggerDeliveryRequest or raw JSON webhook body", Response: "agentclub.TriggerDeliveryResponse"},
		...
		{Method: "POST", Pattern: "/v1/sessions/{id}/agentclub/proposals", Handler: s.handleAgentClubProposalCreate, Summary: "Create a safe-output proposal", Request: "agentclub.ProposalCreateRequest", Response: "agentclub.ProposalCreateResponse"},
		{Method: "GET", Pattern: "/v1/sessions/{id}/agentclub/proposals", Handler: s.handleAgentClubProposalList, Summary: "List safe-output proposals", Response: "agentclub.ProposalListResponse"},
		{Method: "POST", Pattern: "/v1/sessions/{id}/agentclub/proposals/{proposal_id}/decision", Handler: s.handleAgentClubProposalDecision, Summary: "Record a safe-output proposal decision", Request: "agentclub.ProposalDecisionRequest", Response: "agentclub.ProposalDecisionResponse"},
		{Method: "POST", Pattern: "/v1/sessions/{id}/agentclub/proposals/{proposal_id}/apply", Handler: s.handleAgentClubProposalApply, Summary: "Apply an approved safe-output proposal through an allowlisted executor", Request: "agentclub.ProposalApplyRequest", Response: "agentclub.ProposalApplyResponse"},
